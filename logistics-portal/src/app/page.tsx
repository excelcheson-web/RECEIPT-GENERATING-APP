  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Link
          href="/chat"
          className="w-14 h-14 bg-linear-to-br from-[#9DC400] to-[#7A9A00] rounded-full flex items-center justify-center shadow-lg shadow-[#9DC400]/30 hover:scale-110 transition-transform duration-300 group"
          title="Live Chat"
        >
